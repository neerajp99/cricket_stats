  ...
  return (
    <Layout location={props.location}>
      <div className="hidden absolute top-0 right-0 p-24 translate-r-full lg:block md:hidden">
        <svg
          className="block h-48 w-48 transform rotate-180"
          viewBox="0 0 184 184"
      ...
      <div className="overflow-x-hidden overflow-y-hidden container mx-auto justify-center items-center flex flex-col mt-16 ">
        <h1 className="z-10 font-serif text-3xl px-10 font-medium tracking-wide text-center text-black lg:text-6xl lg:px-40 sm:text-4xl sm:px-20">
          {" "}
          Explore{" "}
          <span className="bg-blue-200 px-2 text-blue-700 rounded-md">
            Sachin Tendulkar
          </span>{" "}
          aka Master Blaster{" "}
        </h1>
        <div className="mb-10 mt-12 w-5/6 text-left font-sans font-light text-lg text-gray-600 md:w-2/3 lg:w-1/2 lg:mt-12 sm:w-5/6 sm:mt-10">
          <p className="">
            ...
            of the{" "}
            <span className="bg-yellow-400 text-yellow-800 rounded p-1">
              greatest
            </span>{" "}
            cricket player of all time.
          </p>
          <br />
          <div className="hidden absolute top-3/4 left-0 p-24 translate-l-full lg:block md:hidden">
            <svg
          ...
          <p>
            ...
            is considered one of the complete batsmen ever. He has all the shots
            in the book. He is the most admired cricketer in the world. Every
            Indian should be proud of him.
          </p>
          <br />
          <p>
            He is the{" "}
            ...
            player to have scored one hundred international centuries. He is the
            first batsman to score a double century in a One Day International.
            He is the only player to complete more than
            <span className="bg-blue-200 text-blue-600 p-1 rounded">
              30,000
            </span>{" "}
          ...
          <p>
            ...
            , search for Sachin Tendulkar's{" "}
            <span className="bg-yellow-400 text-yellow-800 rounded p-1">
              best
            </span>{" "}
            records, match details and more about his career.
          </p>
          <Link to="/all">
            {" "}
